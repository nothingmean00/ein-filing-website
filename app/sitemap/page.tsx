...
export default function SitemapPage() {
  ...
  const sitemapSections = [
    ...
    },
    {
      ...
      links: [
        { name: "How to Apply for EIN Online - Complete Guide", url: "/blog/how-to-apply-for-ein-online-complete-guide" },
        { name: "Get EIN Same-Day Fast Track Guide", url: "/blog/get-ein-same-day-fast-track-guide" },
        { name: "EIN vs Federal Tax ID Difference", url: "/blog/ein-vs-federal-tax-id-difference" },
        { name: "EIN Application Methods Comparison", url: "/blog/ein-application-methods-comparison" },
        { name: "EIN Application Rejected Solutions", url: "/blog/ein-application-rejected-solutions" },
        { name: "EIN vs ITIN vs SSN Differences", url: "/blog/ein-vs-itin-vs-ssn-differences" },
      ],
    },
    {
      ...
      links: [
        ...
        { name: "DBA vs EIN Requirements", url: "/blog/dba-vs-ein-requirements" },
        { name: "Business License vs EIN Requirements", url: "/blog/business-license-vs-ein-requirements" },
        { name: "First-Time Entrepreneur EIN Guide", url: "/blog/first-time-entrepreneur-ein-guide" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Request a Correction", url: "/correction-request" },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Billing History", url: "/billing-history" },
